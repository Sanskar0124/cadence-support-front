import { DAY_NAMES, MONTH_NAMES } from '@cadence-support/constants';
...
import { InputTime } from '@cadence-support/widgets';
import moment from 'moment-timezone';
import { useEffect, useState } from 'react';
import { rrulestr } from 'rrule';
import { ARROW_ICON_SIZE, CLOSE_ICON_SIZE } from './constant';
import styles from './InputDateTimeCalendar.module.scss';
import THEMES from './themes';

const InputDateTimeCalendar = ({
  className,
  theme,
  setValue,
  name,
      ...
      setCurrent(
        moment(
          new Date(
            ...
            moment(value[name]).format('MM') - 1,
            moment(value[name]).format('DD')
          )
        )
          .startOf('month')
          .utc('true')
...
export default InputDateTimeCalendar;
