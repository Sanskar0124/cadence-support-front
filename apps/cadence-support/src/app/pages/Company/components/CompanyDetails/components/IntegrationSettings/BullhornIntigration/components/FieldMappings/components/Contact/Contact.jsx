...
function Contact({ companyID }) {
  ...
  const DATA = [
    ...
    { title: 'Source site', value: fieldMappings?.contact_map?.source_site },
    ...
    {
      title: 'Variable 1',
      value: fieldMappings?.contact_map?.variables
        ? fieldMappings?.contact_map?.variables[0]?.target_value?.label
        : null,
    },
    {
      title: 'Variable 2',
      value: fieldMappings?.contact_map?.variables
        ? fieldMappings?.contact_map?.variables[1]?.target_value?.label
        : null,
    },
    {
      title: 'Variable 3',
      value: fieldMappings?.contact_map?.variables
        ? fieldMappings?.contact_map?.variables[2]?.target_value?.label
        : null,
    },
    {
      title: 'Variable 4',
      value: fieldMappings?.contact_map?.variables
        ? fieldMappings?.contact_map?.variables[3]?.target_value?.label
        : null,
    },
  ];
  return (
