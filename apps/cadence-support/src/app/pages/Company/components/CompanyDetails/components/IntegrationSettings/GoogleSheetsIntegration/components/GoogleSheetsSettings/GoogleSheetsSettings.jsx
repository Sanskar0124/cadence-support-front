import styles from './GoogleSheetsSettings.module.scss';
...
function GoogleSheetsSettings({ companyID }) {
      ...
      {isSalesforceSettingsLoading ? (
        ...
        <div className={styles.salesforceSettings}>
          ...
          <div className={`${styles.rowValue} ${styles.connected}`}>
            {salesforceSettings?.User?.integration_id ? (
              <>
                <h2>
              ...
              <h2 className={styles.notConnected}>Not Connected to Sheets</h2>
            )}
          </div>

          {/* <div className={styles.rowTitle}>
        <h1>Sheets Package</h1>
      </div>
      <div
