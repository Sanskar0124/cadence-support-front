      ...
      {isActivityLogsLoading ? (
        ...
        <div className={styles.activityLogs}>
          <div className={styles.rowTitle}>
            <h1>Sync your calendar activities with Dynamics</h1>
          </div>
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your email activities with Dynamics</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your note activities with Dynamics</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your sms activities with Dynamics</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your call activities with Dynamics</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
