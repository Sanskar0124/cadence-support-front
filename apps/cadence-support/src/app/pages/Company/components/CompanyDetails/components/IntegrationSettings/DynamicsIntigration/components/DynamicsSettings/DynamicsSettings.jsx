import styles from './DynamicsSettings.module.scss';
...
function DynamicsSettings({ companyID }) {
        ...
        <div className={styles.salesforceSettings}>
          ...
          <div className={`${styles.rowValue} ${styles.connected}`}>
            {!salesforceSettings?.User?.Google_Sheets_Token?.is_logged_out ? (
              ...
              <h2 className={styles.notConnected}>Not Connected to Dynamics</h2>
            )}
          </div>

          <div className={styles.rowTitle}>
            <h1>Dynamics Package</h1>
          </div>
          <div
