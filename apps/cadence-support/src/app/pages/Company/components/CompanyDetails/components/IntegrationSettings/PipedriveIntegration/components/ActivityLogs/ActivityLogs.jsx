      ...
      {isActivityLogsLoading ? (
        ...
        <div className={styles.activityLogs}>
          <div className={styles.rowTitle}>
            <h1>Sync your calendar activities with Pipedrive</h1>
          </div>
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your email activities with Pipedrive</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your note activities with Pipedrive</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your sms activities with Pipedrive</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
          ...
          <div className={styles.rowTitle}>
            <h1>Sync your call activities with Pipedrive</h1>
          </div>
          <div className={styles.rowValue}>
            <div className={styles.activity}>
              {' '}
